...
namespace Temporal.Sdk.StubGenerator
{
    internal class WorkflowStubTemplateProvider
    {
        ...
        private IList<string> _rawTemplateLines = null;
        ...
        private IList<string> GetRawTemplateLines()
        {
            IList<string> rawTemplateLines = _rawTemplateLines;
            if (rawTemplateLines == null)
            {
                lock (s_ioLock)
                {
                    ...
                    if (rawTemplateLines == null)
                    {
                        ...
                        using (StringReader templateReader = new(Resources.Template__WorkflowStub__))
                        {
                        ...
                        _rawTemplateLines = rawTemplateLines = lines;
                    }
                }
            }
        ...
        private StringBuilder GetTemplate(ref StringBuilder templateCache, string[] enterLines, string[] leaveLines)
        {
            ...
            IList<string> rawTemplateLines = GetRawTemplateLines();
